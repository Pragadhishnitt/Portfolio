      ...
      <div className="max-w-6xl mx-auto">
            ...
            {profile.aboutImage && (
              <div className="mb-10 relative group">
                ...
                <img
                  ...
                  alt="About Me"
                  className="relative w-full h-64 md:h-[500px] object-cover rounded-2xl border border-white/10 shadow-2xl grayscale hover:grayscale-0 transition-all duration-500"
                />
              </div>
            )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {highlights.map((item, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="glass p-6 rounded-2xl hover:bg-surface transition-colors group"
                  >
        ...
        >
          {Object.entries(profile.stats).map(([key, value], index) => (
            <div
              key={index}
              className="glass p-8 rounded-2xl text-center hover:bg-surface transition-colors"
            >
